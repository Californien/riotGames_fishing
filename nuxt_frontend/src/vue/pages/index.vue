    ...
    .mainbox {
        ...
        .stayLoggedInBtn {
            ...
            #stayLoggedInCheckbox {
                ...
                width: 300px;
                &:checked + label {
                    background-color: rgb(213, 50, 53);
                    svg {
                        opacity: 1;
                    }
                    &:hover {
                        background-color: rgb(191, 34, 36);
                    }
                }
            }
            label {
        ...
        #loginBtn {
            ...
            &:disabled {
                cursor: not-allowed;
                background-color: white;
                border: 2px solid rgb(173, 173, 173, 0.2);
                svg {
...
<script lang="ts" setup>
    ...
    const inputPassword = ref({ value: null });
...
<script lang="ts">
    export default {
        ...
        computed: {
            isDisabled() {
                return !(this.input1.trim() !== '' && this.input2.trim() !== '');
            }
        },
        methods: {
            toggleCheckbox() {
                if(this.$refs.checkbox instanceof HTMLInputElement) {
