...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./error-EbENOx0k.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-Dp6Na-DG.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-CLGAgAwl.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-MwFQ-s-P.mjs').then((r) => r.default || r));
